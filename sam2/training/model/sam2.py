...
class SAM2Train(SAM2Base):
    ...
    def forward(self, input: BatchedVideoDatapoint):
        ...
        feats = [feat.permute(1, 2, 0).view(input.flat_img_batch.size(0), -1, *feat_size)for feat, feat_size in zip(vision_feats[::-1], bb_feat_sizes[::-1])][::-1]
        ...
        low_res_masks_logits, iou_predictions, sam_tokens_out, object_score_logits = self.sam_mask_decoder_cs(
        ...
        return low_res_masks_logits_upsample
