...
path = '/shared-local/DATASETS/Video_Anomaly_Segmentation/LiDAR_guided_Small_obstacle_segmentation/' 

iters = 0
iters_total = 0

for label_path in Path(path).glob('**/**/labels/*.png'):
    ...
    save_path_file = save_path_file.replace('/shared-local/DATASETS/Video_Anomaly_Segmentation/LiDAR_guided_Small_obstacle_segmentation/','../anomaly_maps/LiderSOD/')
